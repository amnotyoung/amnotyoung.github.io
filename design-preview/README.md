...
`docs/design-web.md` v0.2를 적용한 독립 홈 시안. 기존 홈의 HTML·CSS는 수정하지 않는다.
...
- `assets/any-logo-mono-reference.jpg`: [any-branding 원본](https://github.com/amnotyoung/any-branding/blob/HEAD/assets/brand/any-logo-mono-reference.jpg), 원본 픽셀 그대로 사용
- 로고 JPG 360×360px, 짙은 도형의 측정 경계 약 x54–299 / y133–217. 파일 표시 폭 100px일 때 도형 약 68px, 모바일 80px일 때 도형 약 54px
- `assets/PretendardVariable.woff2`: [Pretendard v1.3.9](https://github.com/orioncactus/pretendard/tree/v1.3.9), SIL OFL 1.1, `assets/Pretendard-LICENSE.txt` 동봉
